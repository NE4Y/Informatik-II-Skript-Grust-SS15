...
\item[($\rightarrow$ 5)] ($\lambda$ v . e) [x $\rightarrow$ a] = ($\lambda$ v . e [x $\rightarrow$ a]) wenn v nicht frei in a ist
\item[($\rightarrow$ 6)]      ($\lambda$ z . e [v $\rightarrow$ z])[x $\rightarrow$ a] sonst (z : neuer Name)\\
\end{enumerate}
